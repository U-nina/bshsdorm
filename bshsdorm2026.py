...
students_data = [
    ...
    {"floor": "2층", "room": "205", "bed": "2", "id": "2302", "name": "I민우"},
...
academic_calendar = {
    "2026-03-02": "시업식 및 입학식", "2026-03-24": "전국연합학력평가(1,2,3학년)",
    "2026-03-26": "맞춤형 학업성취도 자율평가(1,2학년) / 학부모총회", "2026-04-06": "영어듣기평가(1학년)",
    "2026-04-08": "영어듣기평가(2학년)", "2026-04-09": "영어듣기평가(3학년)",
    "2026-04-27": "1학기 중간고사", "2026-04-28": "1학기 중간고사", "2026-04-29": "1학기 중간고사", "2026-04-30": "1학기 중간고사 종료",
    "2026-05-04": "재량휴업일", "2026-05-05": "어린이날", "2026-05-07": "전국연합학력평가(3학년)",
    "2026-05-15": "체육한마당", "2026-06-03": "지방선거일", "2026-06-04": "학평(1,2학년) / 수능모의평가(3학년)",
    "2026-06-19": "개교기념식", "2026-06-29": "1학기 기말고사 시작", "2026-07-03": "1학기 기말고사 종료",
    "2026-07-06": "학교자율교육과정 시작", "2026-07-08": "학평 (3학년)", "2026-07-16": "방학식",
    "2026-08-18": "2학기 개학식", "2026-09-02": "학평(1,2학년), 모평(3학년)", "2026-09-08": "영어듣기평가(1학년)",
    "2026-09-09": "영어듣기평가(2학년)", "2026-09-10": "영어듣기평가(3학년)", "2026-09-29": "2학기 중간고사", "2026-09-30": "2학기 중간고사", "2026-10-01": "2학기 중간고사", "2026-10-02": "2학기 중간고사 종료", "2026-11-19": "대학수학능력시험일", "2026-11-20": "재량휴업일", "2026-12-31": "방학식",
    "2026-10-12": "현장체험학습(1,2학년)", "2026-10-13": "현장체험학습(1,2학년)", "2026-10-14": "현장체험학습(1,2학년)", "2026-10-15": "현장체험학습(1,2학년)", "2026-10-20": "학평(1,2,3학년)", "2026-11-19": "대수능", "2026-12-07": "2학기 기말고사", "2026-12-07": "2학기 기말고사", "2026-12-08": "2학기 기말고사", "2026-12-09": "2학기 기말고사", "2026-12-10": "2학기 기말고사", "2026-12-11": "2학기 기말고사",
    "2027-02-01": "개학식", "2027-02-04": "졸업식", "2027-02-05": "종업식"
}
...
def fetch_neis_diet(target_date_str):
    ...
    """
    # ⚠️ 이곳에 발급받으신 나이스 공식 인증키 32자리를 대입해 주세요!
    api_key = "cba565bba5a24574b32236c6e0e895fa"
    ...
    try:
        ...
        if "mealServiceDietInfo" in data:
            ...
            for row in row_data:
                ...
                # HTML 줄바꿈 및 불필요 표시 정제
                menu_clean = menu_text.replace("<br/>", ", ")

                # 💡 사용자 요구사항 반영: 알레르기 정보를 하단에 따로 보여줄 것이므로 메뉴 텍스트에서는 숫자 제거 제거
            ...
            if "RESULT" in data and data["RESULT"]["CODE"] == "INFO-200":
                return {"조식": "급식 미운영일입니다.", "중식": "급식 미운영일입니다.", "석식": "급식 미운영일입니다."}
            return {"조식": "인증키 확인 대기 중이거나 급식이 없는 날입니다.", "중식": "나이스 포털 확인 필요", "석식": "사감실 문의"}

        return diet_result
    except Exception as e:
        return {"조식": "데이터 로드 실패", "중식": "나이스 API 확인 요망", "석식": "사감실 문의"}
...
# 4. 오늘의 식단 (🛠️ 알레르기 정보 컴포넌트 하단 탑재 연동)
    ...
    # 💡 [요구사항 반영] 식단 카드 바로 아래 알레르기 유발 식품 표시 패널 레이아웃 적용
    st.markdown("<br>", unsafe_allow_html=True)
    with st.container(border=True):
        st.markdown("### ⚠️ 알레르기 유발 식품 안내 고지")
        st.markdown("""
        * **알레르기 정보 규격 표:**
          * ① 난류 | ② 우유 | ③ 메밀 | ④ 땅콩 | ⑤ 대두 | ⑥ 밀 | ⑦ 고등어 | ⑧ 게 | ⑨ 새우 | ⑩ 돼지고기
          * ⑪ 복숭아 | ⑫ 토마토 | ⑬ 아황산류 | ⑭ 호두 | ⑮ 닭고기 | ⑯ 쇠고기 | ⑰ 오징어 | ⑱ 조개류(굴, 전복, 홍합 포함) | ⑲ 잣
        ---
        *※ 기숙사 입사생 중 특정 성분에 과민 반응이 있는 학생은 사전에 위 번호를 대조하여 섭취에 유의하시기 바랍니다.*
        """)
...
# 5. 학사일정 캘린더
    ...
    calendar_navigation = [
        "2026년 3월", "2026년 4월", "2026년 5월", "2026년 6월", "2026년 7월", "2026년 8월",
        "2026년 9월", "2026년 10월", "2026년 11월", "2026년 12월", "2027년 1월", "2027년 2월"
    ]
    selected_period = st.selectbox("📅 조회 대상 학사월을 선택하세요", calendar_navigation)

    parsed_year = int(selected_period.split("년")[0].strip())
    parsed_month = int(selected_period.split("년")[1].replace("월", "").strip())

    cal = calendar.Calendar(firstweekday=6)
    month_days = cal.monthdayscalendar(parsed_year, parsed_month)
    ...
    for week in month_days:
        ...
        for idx, day in enumerate(week):
            if day == 0:
                ...
                current_date_str = f"{parsed_year}-{parsed_month:02d}-{day:02d}"
                with cols[idx]:
                    if idx == 0:
